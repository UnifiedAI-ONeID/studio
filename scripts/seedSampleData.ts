...
const clearExistingSampleData = async () => {
    ...
    for (const collectionName of collections) {
        const query = db.collectionGroup(collectionName).where('isSampleData', '==', true);
...
const sampleEvents = [
    { id: 'seed_event_1', title: 'Rooftop Jazz Night at Zhongshan', category: 'Music', startTime: getFutureDate(3, 20), city: 'Taipei', neighborhood: 'Zhongshan', hostId: 'seed_user_host_3', priceType: 'paid', priceMin: 600, coverImageUrl: 'https://images.unsplash.com/photo-1619532938034-0a373b577b22?q=80&w=1964&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, priorityScore: 100, stats: { interestedCount: 45, goingCount: 22, savedCount: 15, viewCount: 340 } },
    { id: 'seed_event_2', title: 'Art Walk: Hidden Galleries of Da\'an', category: 'Arts', startTime: getFutureDate(4, 14), city: 'Taipei', neighborhood: 'Da\'an', hostId: 'seed_user_mei', priceType: 'free', coverImageUrl: 'https://images.unsplash.com/photo-1501430654243-c934cec2e1c0?q=80&w=2070&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, priorityScore: 95, stats: { interestedCount: 78, goingCount: 41, savedCount: 20, viewCount: 550 } },
    { id: 'seed_event_3', title: 'Startup Founder Breakfast Meetup', category: 'Networking', startTime: getFutureDate(9, 8), city: 'Taipei', neighborhood: 'Xinyi', hostId: 'seed_user_host_1', priceType: 'paid', priceMin: 250, location: { venueId: 'seed_venue_3' }, coverImageUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=2070&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, stats: { interestedCount: 120, goingCount: 60, savedCount: 35, viewCount: 800 } },
    ...
    { id: 'seed_event_5', title: 'Indie Band Showcase at The Wall', category: 'Music', startTime: getFutureDate(11, 20), city: 'Taipei', location: { venueId: 'seed_venue_5' }, neighborhood: 'Wenshan', hostId: 'seed_user_host_3', priceType: 'paid', priceMin: 400, coverImageUrl: 'https://images.unsplash.com/photo-1496337589254-7e23d04de0f0?q=80&w=2070&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, priorityScore: 90, stats: { interestedCount: 150, goingCount: 80, savedCount: 50, viewCount: 1100 } },
    { id: 'seed_event_6', title: 'Taipei Dumpling Making Class', category: 'Food & Drink', startTime: getFutureDate(12, 18), city: 'Taipei', neighborhood: 'Wanhua', hostId: 'seed_user_alex', priceType: 'paid', priceMin: 1200, coverImageUrl: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?q=80&w=2069&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', stats: { interestedCount: 60, goingCount: 30, savedCount: 25, viewCount: 450 } },
];
...
const seed = async () => {
    // Note: To re-seed, you should run `npm run clear-sample-data` first.
    console.log("Checking for existing sample data before seeding...");
    const sampleCheck = await db.collection('users').where('isSampleData', '==', true).limit(1).get();
    if (!sampleCheck.empty) {
        console.log("\nSample data already exists. To re-seed the database, please run 'npm run clear-sample-data' first.");
        console.log("Seeding process aborted.");
        return;
    }
