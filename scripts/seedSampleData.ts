...
const sampleVenues = [
    { id: 'seed_venue_1', name: 'Midnight Alley Jazz Bar', categories: ['Bar', 'Live music'], address: '123 Fuxing S Rd, Da\'an District', city: 'Taipei', neighborhood: 'Da\'an', homepageTagline: 'Intimate live jazz bar with local bands every weekend.', priceLevel: 3, coverImageUrl: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, createdBy: 'seed_user_alex' },
    { id: 'seed_venue_2', name: 'Daybreak Coffee Lab', categories: ['Cafe'], address: '456 Zhongshan N Rd, Zhongshan District', city: 'Taipei', neighborhood: 'Zhongshan', homepageTagline: 'Bright café with plenty of plugs and quiet corners for deep work.', priceLevel: 2, coverImageUrl: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=2047&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, createdBy: 'seed_user_mei' },
    { id: 'seed_venue_3', name: 'Cornerstone Community Hub', categories: ['Coworking', 'Community'], address: '789 Xinyi Rd, Xinyi District', city: 'Taipei', neighborhood: 'Xinyi', homepageTagline: 'A space for creators, innovators, and neighbors to connect.', priceLevel: 2, coverImageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, createdBy: 'seed_user_host_1' },
    { id: 'seed_venue_4', name: 'Lightbox Art Space', categories: ['Art Gallery'], address: '101 Songde Rd, Xinyi District', city: 'Taipei', neighborhood: 'Xinyi', homepageTagline: 'Showcasing contemporary digital and interactive art.', priceLevel: 1, coverImageUrl: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?q=80&w=2067&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, createdBy: 'seed_user_mei' },
    { id: 'seed_venue_5', name: 'The Wall Live House', categories: ['Live music'], address: 'B1, No. 200, Section 4, Roosevelt Rd, Wenshan District', city: 'Taipei', neighborhood: 'Wenshan', homepageTagline: 'Taipei\'s legendary underground music venue.', priceLevel: 2, coverImageUrl: 'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, createdBy: 'seed_user_host_3' },
];

const sampleEvents = [
    { id: 'seed_event_1', title: 'Rooftop Jazz Night at Zhongshan', category: 'Music', startTime: getFutureDate(3, 20), city: 'Taipei', neighborhood: 'Zhongshan', hostId: 'seed_user_host_3', priceType: 'paid', minPrice: 600, coverImageUrl: 'https://images.unsplash.com/photo-1619532938034-0a373b577b22?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isFeaturedOnLanding: true, priorityScore: 100, stats: { interestedCount: 45, goingCount: 22 } },
...
const sampleThreads = [
    ...
    { id: 'seed_thread_3', title: 'Looking for a co-working space near an MRT line', topic: 'Tips', city: 'Taipei', body: 'Remote worker here. My apartment is getting too cramped. I need a co-working space with reliable internet that\'s a short walk from any MRT station. Any favorites?', authorId: 'seed_user_liam', stats: { replyCount: 2, viewCount: 95, likeCount: 8 }, relatedVenueId: 'seed_venue_3' },
];
